...
export class Filters extends StoreObserver {
  ...
  constructor(props, context) {
    ...
    const store = AdvertsStore.getState();

    this.state = {
      show: false,
      cities: getAllFields(store, 'city'),
      countries: getAllFields(store, 'country'),
    };
  ...
  toggleFilter(field, type) {
    ...
    AdvertsActions.applyFilters.defer({ city: cities, country: countries });
