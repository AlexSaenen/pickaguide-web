...
export let strings = new LocalizedStrings({
   en:{
      ...
      infoLogin1:"You can access a Map with all available visits around you, you just need to ",
      infoLogin2:"log in",
      infoLogin3:" or  ",
      infoLogin4:"create",
      infoLogin5:" an account",
      visitMap:"There might be some available visits <strong>around you</strong>, why don't you have a look on the Map below ?",
   ...
   fr:{
      ...
      infoLogin3:" ou  ",
      infoLogin4:"créer",
      infoLogin5:" un compte",
      visitMap:"Il semble y avoir des visites <strong>autour de vous</strong>, Pourquoi ne pas regarder la carte ?",
      exploreVisit:"Explorer toutes les visites autour de vous"
   }
});