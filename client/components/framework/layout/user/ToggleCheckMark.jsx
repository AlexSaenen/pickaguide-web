...
export class ToggleCheckMark extends PropsComponent {
  ...
  render() {
    return (
      <div>
        <p className="arrow_box" style={{ display: 'inline-block', backgroundColor: '#3973BF', borderRadius: '0.4em', padding: '0.2em 0.6em', margin: '0 0.8em', color: 'white', verticalAlign: 'middle' }}>{this.state.active ? 'disable' : 'enable'}</p>
